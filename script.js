document.addEventListener('DOMContentLoaded', () => {
    ...
    uploadButton.addEventListener('click', async () => {
        ...
        suggestionsContentDiv.innerHTML = '<p>等待影片分析完成以獲取建議...</p>';
        ...
        try {
            ...
            websocket.onmessage = (event) => {
                ...
                if (m.stride_angle !== undefined && m.stride_angle < 15) {
                    suggestionsContentDiv.innerHTML = '<p style="color: orange;">建議：步幅角度過小，應大於 15 度。</p>';
                } else if (m.throwing_angle !== undefined && m.throwing_angle > 120) {
                    suggestionsContentDiv.innerHTML = '<p style="color: orange;">建議：投擲角度過大，應低於 120 度。</p>';
                } else if (m.arm_symmetry !== undefined && m.arm_symmetry < 1) {
                    suggestionsContentDiv.innerHTML = '<p style="color: green;">手臂對稱性表現良好！</p>';
                } else {
                    suggestionsContentDiv.innerHTML = '<p>分析中...請等待更多數據</p>';
                }
            };
